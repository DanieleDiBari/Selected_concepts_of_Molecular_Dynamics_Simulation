...
\begin{frame}
	...
	\small{
   			...
   			must in principle be based on quantum mechanics,\\
...
\begin{frame}
	...
	\begin{block}{\small{Neither relativistic nor quantum effects are considered}}\justifying\small{
		\textbf{Special relativity} does not allow that information travels faster than light; Molecular Dynamics simulations assume forces with 
